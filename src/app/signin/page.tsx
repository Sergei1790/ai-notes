        ...
        <main className="min-h-screen flex items-center justify-center p-6">
            <div className="w-full max-w-4xl grid lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-5">
                    <h1 className="text-3xl lg:text-4xl font-bold bg-clip-text text-transparent" style={{backgroundImage: 'linear-gradient(to right, var(--color-primary), var(--color-highlight))'}}>
                        AI Notes
                    </h1>
                    <p className="text-muted text-base">Smart note-taking with AI-powered summaries and tags.</p>
                    ...
                    <div className="rounded-2xl overflow-hidden border border-white/10">
                        <Image src="/screenshot.png" alt="AI Notes preview" width={800} height={500} className="w-full h-auto" />
                    </div>
                </div>
                ...
                <div className="bg-card border border-white/10 rounded-2xl p-8 w-full space-y-4">
                    ...
                    <p className="text-xs text-muted text-center pt-2">We only store your name, email, and avatar.</p>
                </div>
            </div>
        </main>
    );
